...
nombre_usuario.innerText=datos.usuario+(datos.usuarios[datos.usuario].hasOwnProperty("plan")?(" con: "+datos.usuarios[datos.usuario].plan):"");
...
// console.log(datos.usuarios[datos.usuario].musica_actual);
